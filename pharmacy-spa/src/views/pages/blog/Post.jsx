  ...
  return (
    <main className='mt-10 bg-white'>
      ...
      >
        ...
        />
        <img
          src='https://media.gq.com/photos/61d72f49e93c95dc9bbfb8c1/master/pass/cerave.jpg'
          className='absolute left-0 top-0 w-full h-full z-0 object-cover'
        />
        <div className='p-4 absolute bottom-0 left-0 z-20 flex gap-2'>
          <Link
            to='/'
            className='px-4 py-1 bg-black text-gray-200 inline-flex items-center justify-center mb-2 rounded'
          >
            SkinCare
          </Link>
          <Link
