...
const Profile = () => {
  ...
  const getMyOrders = async () => {
    try {
      await axiosClient.get('/orders').then(({ data }) => {
        if (data) {
          setOrders(data.data)
        }
      })
  ...
  return (
    <section className=' mt-20 max-w-7xl mx-auto mb-96'>
      <div className='container mx-auto my-5 p-5 '>
        <div className='md:flex no-wrap md:-mx-2 '>
          {/* <!-- Left Side --> */}
          <div className='w-full md:w-3/12 md:mx-2'>
            {/* <!-- Profile Card --> */}
            <div className='bg-white p-3 border-t-4 border-[#9fe870]'>
              ...
              <ul className='bg-gray-100 text-gray-600 hover:text-gray-700 hover:shadow py-2 px-3 mt-3 divide-y rounded shadow-sm'>
                <li className='flex text-sm items-center py-3'>
                  ...
                  <span className='ml-auto'>{convertDate(user.date)}</span>
                </li>
              </ul>
            </div>
            {/* <!-- End of profile card --> */}
          ...
          <div className='w-full md:w-9/12 mx-2 h-64'>
            {/* <!-- About Section --> */}
            <div className='bg-white p-3 shadow-sm rounded-sm border-t-4 border-[#9fe870]'>
              ...
              <div className='text-gray-700'>
                <div className='grid md:grid-cols-2 text-sm'>
                  <div className='grid grid-cols-2'>
                    ...
                    <div className='px-4 py-2'>{user.first}</div>
                  </div>
                  <div className='grid grid-cols-2'>
                    <div className='px-4 py-2 font-semibold'>Last Name</div>
                    <div className='px-4 py-2'>{user.last}</div>
                  </div>
                  <div className='grid grid-cols-2'>
                  ...
                  <div className='grid grid-cols-2'>
                    ...
                    <div className='px-4 py-2'>
                      {user.streetAddress ? user.streetAddress : 'not set'}
                    </div>
                  </div>
                  <div className='grid grid-cols-2'>
            ...
            <div className='bg-white p-3 shadow-sm rounded-sm border-t-4 border-[#9fe870] max-h-96 overflow-auto'>
              <div className=''>
                <div className=''>
                    ...
                    <tbody>
                      {orders.length > 0 ? (
                        ...
                        <>
                          <tr>
                            <td
                              className='px-4 py-4 text-sm text-center font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap'
                              colSpan='5'
                            >
                              No Order To Display
                            </td>
